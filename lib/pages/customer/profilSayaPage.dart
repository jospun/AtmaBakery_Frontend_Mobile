                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Center(
                        child: Stack(
                          ...
                          children: [
                            CircleAvatar(
                            radius: 45,
                            backgroundImage: _userData?.foto_profil != null
                          ? FileImage(File(_userData!.foto_profil!)) as ImageProvider<Object>
                          : NetworkImage(
                      ...
                      } else if (!RegExp(r'^\+?08\d{8,}$').hasMatch(value)) {
...
void _handlePickedFile(PickedFile? pickedFile) {
  if (pickedFile != null) {
    ...
    if (pickedFile.path.endsWith('.jpg') || pickedFile.path.endsWith('.jpeg') || pickedFile.path.endsWith('.png')) {
      setState(() {
        _userData!.foto_profil = pickedFile.path;
      });
    } else {
